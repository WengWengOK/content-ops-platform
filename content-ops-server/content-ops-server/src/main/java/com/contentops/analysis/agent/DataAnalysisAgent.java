 ...
 *
 * <p>Actual bean is built programmatically in {@link com.contentops.analysis.config.AnalysisAgentConfig} using
...
public interface DataAnalysisAgent {
     ...
     */
    @UserMessage("""
            输出 JSON 结构必须严格为：{"keyMetrics":{},"categoryPerformance":[{"category":"","avgReads":0,"avgLikes":0,"avgShares":0,"engagementRate":0,"articleCount":0}],"timeSlotPerformance":[{"dayOfWeek":"","timeRange":"","avgEngagement":0,"articleCount":0}],"insights":[],"recommendations":[],"chartData":{}}
    ...
    AnalysisReport analyzePerformance(@MemoryId String memoryId,
                                      ...
                                      @V("previousAnalysisSummary") String previousAnalysisSummary);
}
