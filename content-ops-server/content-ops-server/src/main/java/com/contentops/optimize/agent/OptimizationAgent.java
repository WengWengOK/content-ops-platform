 ...
 *
 * <p>Actual bean is built programmatically in {@link com.contentops.optimize.config.OptimizeAgentConfig} using
...
public interface OptimizationAgent {
     ...
     */
    @UserMessage("""
            输出 JSON 结构必须严格为：{"strategyAdjustments":[{"dimension":"content_type","currentValue":"","recommendedValue":"","rationale":"","expectedImpact":0.0}],"recommendedTopics":[],"learnings":[],"healthScore":80,"cycleSummary":""}
    ...
    OptimizationResult optimizeStrategy(@MemoryId String memoryId,
                                        ...
                                        @V("analysisSummary") String analysisSummary,
                                        @V("currentStrategy") String currentStrategy,
                                        @V("historicalPerformance") String historicalPerformance);
}
