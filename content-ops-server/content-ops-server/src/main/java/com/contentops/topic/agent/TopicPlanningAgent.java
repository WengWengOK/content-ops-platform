 ...
 *
 * <p>Actual bean is built programmatically in {@link com.contentops.topic.config.TopicAgentConfig} using
...
public interface TopicPlanningAgent {
     ...
     */
    @UserMessage("""
            输出 JSON 结构必须严格为：{"topics":[{"title":"","angle":"","rationale":"","estimatedEngagement":0.0,"keywords":[],"platformAdaptations":{}}],"trendingKeywords":[],"competitiveAnalysis":"","recommendedDirection":""}
    ...
    TopicPlanResult planTopics(@MemoryId String memoryId,
                               ...
                               @V("tone") String tone,
                               @V("platforms") List<String> platforms,
