...
public class ModelRoutingService {
    ...
    // ──────────────── 创意类阶段默认参数 ────────────────
    private static final String CREATIVE_MODEL = "deepseek-chat";
    private static final double CREATIVE_TEMPERATURE = 0.8;
    private static final int CREATIVE_MAX_TOKENS = 8192;

    // ──────────────── 格式化类阶段默认参数 ────────────────
    private static final String FORMATTING_MODEL = "deepseek-chat";
    private static final double FORMATTING_TEMPERATURE = 0.3;
    private static final int FORMATTING_MAX_TOKENS = 8192;
