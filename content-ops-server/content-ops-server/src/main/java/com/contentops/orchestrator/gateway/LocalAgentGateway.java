...
@Slf4j
@Component
// 直接读取环境变量（不经过 YAML 占位符），确保 CONTENTOPS_MODE 能正确驱动条件装配
@ConditionalOnProperty(name = "CONTENTOPS_MODE", havingValue = "monolithic", matchIfMissing = true)
...
public class LocalAgentGateway implements AgentGateway {
    ...
    public AgentResponse<Map<String, Object>> callTopic(AgentTaskRequest request) {
        ...
        return costGuard.withWorkflow(request.getWorkflowId(), () -> topicAgentController.execute(request));
    }
    ...
    public AgentResponse<Map<String, Object>> callContentExecute(AgentTaskRequest request) {
        ...
        return costGuard.withWorkflow(request.getWorkflowId(), () -> contentAgentController.execute(request));
    }
    ...
    public AgentResponse<Map<String, Object>> callContentOutline(AgentTaskRequest request) {
        ...
        return costGuard.withWorkflow(request.getWorkflowId(), () -> contentAgentController.generateOutline(request));
    }
    ...
    public AgentResponse<Map<String, Object>> callContentDraft(AgentTaskRequest request) {
        ...
        return costGuard.withWorkflow(request.getWorkflowId(), () -> contentAgentController.generateDraft(request));
    }
    ...
    public AgentResponse<Map<String, Object>> callImageExecute(AgentTaskRequest request) {
        ...
        return costGuard.withWorkflow(request.getWorkflowId(), () -> imageAgentController.execute(request));
    }
    ...
    public AgentResponse<Map<String, Object>> callImageStyles(AgentTaskRequest request) {
        ...
        return costGuard.withWorkflow(request.getWorkflowId(), () -> imageAgentController.generateStyleDirections(request));
    }
    ...
    public AgentResponse<Map<String, Object>> callImageGenerate(AgentTaskRequest request) {
        ...
        return costGuard.withWorkflow(request.getWorkflowId(), () -> imageAgentController.generateImages(request));
    }

    @Override
    public AgentResponse<Map<String, Object>> callPublish(AgentTaskRequest request) {
        log.debug("[Local] Calling PublishAgent directly");
        return costGuard.withWorkflow(request.getWorkflowId(), () -> publishAgentController.execute(request));
    }
    ...
    public AgentResponse<Map<String, Object>> callAnalysis(AgentTaskRequest request) {
        ...
        return costGuard.withWorkflow(request.getWorkflowId(), () -> analysisAgentController.execute(request));
    }
    ...
    public AgentResponse<Map<String, Object>> callOptimize(AgentTaskRequest request) {
        ...
        return costGuard.withWorkflow(request.getWorkflowId(), () -> optimizeAgentController.execute(request));
    }
    ...
    public AgentResponse<DiscussionResponse> chatDiscussion(String sessionId, Map<String, Object> request) {
        ...
        return costGuard.withWorkflow(sessionId, () -> discussionController.chat(sessionId, request));
    }
    ...
    public AgentResponse<TopicPlanResult> finalizeDiscussion(String sessionId) {
        ...
        return costGuard.withWorkflow(sessionId, () -> discussionController.finalize(sessionId));
    }
    ...
    public AgentResponse<DiscussionSession> getDiscussionSession(String sessionId) {
        ...
        return costGuard.withWorkflow(sessionId, () -> discussionController.getSession(sessionId));
    }
    ...
    public AgentResponse<Void> clearDiscussionSession(String sessionId) {
        ...
        return costGuard.withWorkflow(sessionId, () -> discussionController.clearSession(sessionId));
    }
}
