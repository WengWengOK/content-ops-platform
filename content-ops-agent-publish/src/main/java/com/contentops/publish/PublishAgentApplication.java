package com.contentops.publish;
...
/**
 * Publishing Agent microservice entry point.
 *
 ...
 * {@link com.contentops.publish.config.PublishAgentConfig} to be the single source of the
 * {@link com.contentops.publish.agent.PublishingAgent} bean, built programmatically via
...
@SpringBootApplication(
        scanBasePackages = {"com.contentops.publish", "com.contentops.common"},
        excludeName = "dev.langchain4j.spring.LangChain4jAutoConfig"
)
@EnableDiscoveryClient
public class PublishAgentApplication {

    public static void main(String[] args) {
        SpringApplication.run(PublishAgentApplication.class, args);
    }
}
